            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        ...
                        case 3:
                            _b.type = (_d.sent()).value;
                            _d.label = 4;
                        case 4:
                            if (!(arg.type == 'vue')) return [3 /*break*/, 6];
                            //VUE arguments
                            console.log('');
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, dmgMount(dmg.path)];
                        case 2:
                            mount_path = _a.sent();
                        ...
                        case 3:
                            _a.sent();
                            //cleanup
                            return [4 /*yield*/, dmgUnMount(mount_path)];
                        case 4:
                            //cleanup
                            _a.sent();
                            //end
